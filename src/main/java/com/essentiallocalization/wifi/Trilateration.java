...
public final class Trilateration {
    ...
    /**
     * Free space pos loss distance in meters
     * TODO
     */
    public static double calcFsplDistance(double levelInDb, double freqInMHz)    {
     ...
     * @param r1 Anchor 1's signal radius in meters
     * @param r2 Anchor 2's signal radius in meters
     ...
     * @see <a href='http://en.wikipedia.org/wiki/Trilateration'>wikipedia.org/wiki/Trilateration</a>
     * @param r1 Anchor 1's signal radius in meters
     * @param r3 Anchor 3's signal radius in meters
