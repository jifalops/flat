...
import com.essentiallocalization.bluetooth.TimingLog;
import com.essentiallocalization.bluetooth.connection.DataPacket;
import com.essentiallocalization.bluetooth.BluetoothConnection;
import com.essentiallocalization.bluetooth.BluetoothConnectionManager;
 ...
 */
public final class BluetoothFragment extends PersistentIntentServiceFragment {
                    ...
                    protected Void doInBackground(Void... params) {
                        for (int i = 0; i < TEST_MULTIPLIER; ++i) {
                            if (isBound()) {
                                ...
                                } catch (com.essentiallocalization.bluetooth.connection.Message.MessageTooLongException ignored) {}
                            }
                            try {
                                Thread.sleep(10);
