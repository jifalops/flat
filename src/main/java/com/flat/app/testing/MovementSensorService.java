...
public final class MovementSensorService extends PersistentIntentService {
    ...
    private InertialMovementEventListener mMovementSensor;

    public InertialMovementEventListener getMovementSensor() {
    ...
    public void onCreate() {
        ...
        mMovementSensor = new InertialMovementEventListener();
